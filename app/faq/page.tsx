...
const faqData: FAQItem[] = [
  // 서비스 관련
  {
    ...
    answer: "LawScan은 강남 최고급 로펌의 전문 변호사가 직접 계약 리스크를 분석하고 관리하는 서비스입니다. 계약서 업로드 후 전문가가 1차 분석을 수행하고, 전문 변호사가 2차 검증을 거쳐 완벽한 계약 리스크 관리 솔루션을 제공합니다.",
    category: "서비스"
  },
  {
    question: "어떤 종류의 계약서를 분석할 수 있나요?",
    answer: "M&A 계약, 투자 계약, 공급망 계약, 고용 계약, 부동산 계약, 대출 계약, 보험 계약 등 모든 종류의 계약서를 분석할 수 있습니다. 우리의 전문가는 수천 건의 검증된 계약서와 판례를 바탕으로 다양한 계약 유형에 대응합니다.",
    category: "서비스"
  },
  {
    question: "분석 결과는 얼마나 정확한가요?",
    answer: "우리의 전문 변호사 팀은 높은 정확도로 계약 리스크를 진단합니다. 강남 최고급 로펌의 엘리트 변호사들이 직접 검토하여 엔터프라이즈급 품질을 보장합니다.",
    category: "서비스"
  },
  {
    question: "분석에 얼마나 시간이 걸리나요?",
    answer: "1차 분석은 수 분 내에 완료되며, 전문 변호사의 2차 검증은 계약의 복잡도에 따라 24-48시간 내에 완료됩니다. 긴급한 경우 우선 처리 서비스도 제공합니다.",
    category: "서비스"
  },
  {
    question: "LawScan의 분석 결과는 얼마나 빨리 받을 수 있나요?",
    answer: "계약서 업로드 즉시 예비 분석 결과를 수 분 내에 제공합니다. 빠른 피드백으로 신속한 의사결정이 가능합니다.",
    category: "서비스"
  },
  {
    question: "LawScan을 이용하면 어떤 비용/시간 절감 효과가 있나요?",
    answer: "효율적인 전문가 검토로 기존 대비 최대 70% 시간과 60% 비용을 절감할 수 있습니다.",
    category: "서비스"
  },
  {
  ...
  {
    question: "시스템은 어떻게 작동하나요?",
    answer: "우리의 시스템은 수천 건의 검증된 계약서와 판례를 바탕으로 계약의 잠재적 리스크를 식별합니다. 자연어 처리 기술을 통해 계약 조항을 분석하고, 법적 구속력, 손해배상, 해지 조건 등을 검토합니다.",
    category: "기술"
  },
  {
