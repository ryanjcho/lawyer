        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8">
              AI와 법률 전문가가 유통 기업의 계약 리스크를 최소화합니다
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">온라인 거래</h3>
              <p className="text-gray-600">
                온라인 쇼핑몰 및 전자상거래 계약 관리
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-8">
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-6">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">소비자 보호</h3>
              <p className="text-gray-600">
                소비자 보호법 및 전자상거래법 준수
              </p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">입점 계약</h3>
                  <p className="mt-2 text-gray-600">
                    - 입점 조건 및 수수료<br />
                    - 운영 규정<br />
                    - 매출 정산
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">물류 계약</h3>
                  <p className="mt-2 text-gray-600">
                    - 물류 서비스 범위<br />
                    - 배송 조건<br />
                    - 보관 및 관리
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-gray-900">마케팅 계약</h3>
                  <p className="mt-2 text-gray-600">
                    - 프로모션 조건<br />
                    - 광고 및 홍보<br />
                    - 브랜드 사용
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 text-center">
              <div className="text-4xl font-bold text-blue-600 mb-2">36h</div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-4">
                리테일테크는 온라인 쇼핑몰 입점 계약을 검토하여 운영 리스크를 90% 감소시키고, 매출을 30% 증가시켰습니다.
              </p>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              ...
              <p className="text-gray-600 mb-4">
                글로벌마켓은 글로벌 공급망 계약을 검토하여 물류 비용을 25% 절감하고, 배송 시간을 40% 단축했습니다.
              </p>
              <div className="flex items-center text-sm text-gray-500">
                <span>공급망</span>
                <span className="mx-2">•</span>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              유통 기업 고객들이 자주 문의하는 질문들
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4">
                온라인 쇼핑몰 계약도 처리 가능한가요?
              </h3>
              <p className="text-gray-600">
                네, 온라인 쇼핑몰 계약도 처리 가능합니다. 전자상거래법과 소비자보호법을 준수하는 계약 검토를 제공합니다.
              </p>
            </div>
            <div className="bg-white rounded-xl shadow-lg p-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4">
                글로벌 공급망 계약은 어떻게 관리하나요?
              </h3>
              <p className="text-gray-600">
                글로벌 공급망 계약은 다국어 검토와 국제 무역 규정 준수를 보장하며, 물류 및 관세 관련 조항을 포함합니다.
              </p>
            </div>
          </div>
        </div>
